...
import { Grid, Card, CardContent, Typography, Box, Divider, IconButton, Menu, MenuItem } from '@mui/material';
...
const TaskListItem: React.FC<{ task: ITask; showMenu?: boolean }> = ({ task, showMenu = true }) => {
